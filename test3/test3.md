...
<pre><code>CREATE TABLE orders 
 ...
 ### 创建order_details表:
 <pre><code>CREATE TABLE order_details
(
...
### 查询语句：
select count(*) from orders a,order_details b where a.order_id=b.order_id;//查询数数据匹配条数<br>
select * from orders a,order_details b where a.order_id=b.order_id;//查询匹配数据
