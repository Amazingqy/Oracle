...
ALTER USER qiuyu QUOTA UNLIMITED ON USERS;

ALTER USER qiuyu QUOTA UNLIMITED ON USERS02;

ALTER USER qiuyu QUOTA UNLIMITED ON USERS03;

ALTER USER qiuyu ACCOUNT UNLOCK;



--roles

GRANT "CONNECT" TO qiuyu WITH ADMIN OPTION;

GRANT "RESOURCE" TO qiuyu WITH ADMIN OPTION;

ALTER USER qiuyu DEFAULT ROLE "CONNECT","RESOURCE";



-- SYSTEM PRIVILEGES

GRANT CREATE VIEW TO qiuyu WITH ADMIN OPTION;
...
INSERT INTO qiuyu.DEPARTMENTS(DEPARTMENT_ID,DEPARTMENT_NAME) values (1,'总经办');
...
insert into qiuyu.ORDERS (ORDER_ID,CUSTOMER_NAME,CUSTOMER_TEL,ORDER_DATE,EMPLOYEE_ID,DISCOUNT)
...
insert into qiuyu.ORDER_DETAILS(ID,ORDER_ID,PRODUCT_NAME,PRODUCT_NUM,PRODUCT_PRICE)
...
select sum(PRODUCT_NUM*PRODUCT_PRICE) into m from qiuyu.ORDER_DETAILS where ORDER_ID=v_order_id;
...
ALTER INDEX qiuyu.ORDERS_INDEX_DATE
...
select * from qiuyu.VIEW_ORDER_DETAILS where order_id=10012;
...
FROM A, qiuyu.employees B WHERE A.EMPLOYEE_ID = B.MANAGER_ID)
